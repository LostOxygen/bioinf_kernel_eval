...
python main.py --model_type vgg19 --batch_size "$BATCH_SIZE" --learning_rate "$LEARNING_RATE" --epochs "$EPOCHS" --gpu 2 && python main.py --model_type vgg19 --batch_size "$BATCH_SIZE" --learning_rate "$LEARNING_RATE" --epochs "$EPOCHS" --gpu 3 --depthwise
